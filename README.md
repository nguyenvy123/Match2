...
|---|---|---|---|
| 1–2 | Đặt ly | 3–4 | 6 · 24 |
| 3–5 | Đặt ly + ⚡ Đặt đôi | 5–7 | 120 · 720 · 5 040 |
...
Thông tin nằm ở **mức thay đổi của con số** giữa các lượt, không phải bản thân con số. Bảng "Đã thử" ghi lại toàn bộ lịch sử để bạn so sánh — khác với round 1–5 nơi bạn phải tự nhớ.

Kịch bản này khó hơn hẳn ở cùng số ly, nên số ly lùi về 5–6.
...
Ở round 5 với 7 ô, số cặp ly–ô cần theo dõi lên tới 42. Ngưỡng trí nhớ làm việc của người bình thường là khoảng 7 mục, nên từ round 3 trở đi bạn buộc phải có chiến lược ghi nhớ nào đó.
...
- **Bàn phím:** `A`–`G` chọn ly · `1`–`7` chọn ô · `Esc` huỷ · `R` chơi lại ván
...
Round 1–5 (đặt ly): trung bình tối ưu 4.5 / 7 / 10 / 13.5 / 17.5 lần đặt — kiểm chứng bằng mô phỏng trong `game.test.js`. Đó là số của người nhớ hoàn hảo; người chơi thật sẽ cao hơn, và điều đó cố ý.

Round 6–7 (hoán đổi): tối ưu 4.7 / 5.7 lượt với chiến thuật lọc dần tập hoán vị. Người chơi thật cần ~20 / ~31 lượt, tức 4–5× mức tối ưu — khoảng cách đó chính là biên độ kỹ năng.
